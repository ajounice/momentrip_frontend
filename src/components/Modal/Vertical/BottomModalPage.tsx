...
import '../../../styles/components/Modal/Vertical/BottomModalPage.css';
...
export default function BottomModalPage({
  open,
  setOpen,
  title,
  desc,
              ...
              >
                <div>
                  <div className="mt-3 text-center sm:mt-5">
                    {/* header */}
                    {close && <RiCloseFill className="w-6 h-6 absolute right-5 top-5" onClick={() => setOpen(false)}></RiCloseFill>}
                    {/*{title && (*/}
