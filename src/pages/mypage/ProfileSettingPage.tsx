...
const ProfileSettingPage = () => {
  ...
  const onClickProfileSetting = ()=> {
    ...
    if (data.length !== 0 && profileImgData === '') {
      axios.patch(`${SERVER_API}/users/my/edit/update`, data,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          }
  ...
  return(
    <div className={'profile-setting-page-container'}>
        <div className={'profile-setting-page-top-bar-container'}>
          <TopBar beforeButton={true} centerText={""} centerTextType={"page"} checkButton={true} checkButtonOnClickEvent={onClickProfileSetting}/>
        </div>
        ...
        <div className={'profile-setting-image-container'}>
          ...
          <div className={'profile-setting-user-ingo-container'}>
            ...
            */}
            ...
            <Input onChangeEventHandler={(e)=>{
              setModiInfo({
                ...modiInfo,
                nickname : e.currentTarget.value
              })
            }} defaultValue={myInfo.nickname} label={"아이디"} type={"text"} id={"id"} disabled={false} placeholder={"텍스트를 입력해주세요."}/>
            {/* 특수문자 사용가능 */}
            <Input onChangeEventHandler={(e)=>{
              setModiInfo({
                ...modiInfo,
              ...
              label={"이름"} type={"text"} id={"name"} disabled={false} placeholder={"텍스트를 입력해주세요."}/>
            {/**/}
            <Input
              ...
              defaultValue={myInfo.intro}  label={"소개"} type={"text"} id={"introduction"} disabled={false} placeholder={"텍스트를 입력해주세요."}/>
