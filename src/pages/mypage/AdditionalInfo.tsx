...
function AdditionalInfo() {
  ...
  const onClickSubmit = (e: any) => {
    if (id !== '' && name !== '') {
      if (profileImgSrc !== '') {
        axios
          .patch(`${process.env.REACT_APP_API_URL}/users/my/edit/image`, profileImgData, {
            headers: {
      ...
      // nickname 중복 확인하기
      axios({
        // url : `${process.env.REACT_APP_API_URL}/users/nickname/duplicate`,
        method: 'post',
        url: `${process.env.REACT_APP_API_URL}/users/my/edit/nickname/duplicate`,
        data: {
          nickname: id,
        },
        headers: {
        ...
        .then((res) => {
          if (res.data === false) {
            ...
            axios
              .patch(
                `${process.env.REACT_APP_API_URL}/users/my/edit`,
                {
                  nickname: id,
                  name: name,
                  intro: introduction,
  ...
  return (
    <div className={'additional-info-container'}>
      <TopBar
        ...
        centerTextType={'page'}
        checkButton={true}
        checkButtonOnClickEvent={onClickSubmit}
      />
